...
echo "========================================"
echo "JAVASCRIPT - HOT START Benchmark"
echo "========================================"
...
for i in $(seq 1 $ITERATIONS); do
    ...
    RESULT_FILE="$OUTPUT_DIR/javascript_hot_${TIMESTAMP}_iter${i}.json"
...
echo "========================================"
echo "JAVASCRIPT HOT START - Complete!"
echo "Results in: $OUTPUT_DIR"
echo "Total files: $(ls -1 $OUTPUT_DIR | wc -l)"
echo "Final pod: $(kubectl get pods -n openwhisk | grep networkbenchjs | awk '{print $1}')"
echo "========================================"